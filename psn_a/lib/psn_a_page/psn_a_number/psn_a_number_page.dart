...
import 'package:psn_a/psn_a_page/psn_a_number/psn_a_number_con.dart';
...
class PsnANumberPage extends PsnRootPage<PsnANumberCon>{
  @override
  PsnANumberCon onCon() => PsnANumberCon();
  ...
  _textWidget()=>Container(
    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(
          height: 93.h,
          child: GetBuilder<PsnANumberCon>(
            id: "win",
