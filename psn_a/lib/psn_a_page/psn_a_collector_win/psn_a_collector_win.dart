...
import 'package:psn_a/psn_a_page/psn_a_collector_win/psn_a_collector_win_con.dart';
...
class PsnACollectorWin extends PsnRootPage<PsnACollectorWinCon>{
  @override
  PsnACollectorWinCon onCon() => PsnACollectorWinCon();
    ...
    child: Scratcher(
      ...
      child: Stack(
        ...
        children: [
          ...
          GetBuilder<PsnACollectorWinCon>(
            id: "list",
