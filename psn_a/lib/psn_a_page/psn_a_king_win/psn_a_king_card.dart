...
import 'package:psn_a/psn_a_page/psn_a_dog_win/psn_a_dog_win_con.dart';
import 'package:psn_a/psn_a_page/psn_a_king_win/psn_a_king_card_con.dart';
...
class PsnAKingCard extends PsnRootPage<PsnAKingCardCon>{
  @override
  PsnAKingCardCon onCon() => PsnAKingCardCon();
      ...
      child: Stack(
        ...
        children: [
          ...
          Container(
            ...
            child: GetBuilder<PsnAKingCardCon>(
              id: "list",
              builder: (_){
