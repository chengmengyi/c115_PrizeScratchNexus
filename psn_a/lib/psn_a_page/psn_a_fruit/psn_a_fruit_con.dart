...
class PsnAFruitCon extends PsnRootCon implements PlayListener{
  ...
  void onInit() {
    ...
    playUtils=PsnAPlayUtils(
      cardTypeEnum: PsnACardTypeEnum.fruitLineup,
      playListener: this,
    );
  }
  ...
  List<PsnAContentBean> generateFruitBeans(int n) {
    ...
    for (int i = 0; i < 4; i++) {
      ...
      for (String fruit in groups[i]) {
        result.add(PsnAContentBean(content: fruit, reward: rewardValue,win: isTriple));
      }
    }
